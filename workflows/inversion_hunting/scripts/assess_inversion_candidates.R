...
invcandsV$validation[invcandsV$valid & invcandsV$admixed] <- "d:F3"
invcandsV$validation[invcandsV$valid & invcandsV$hzgood] <- "d:HZ"
invcandsV$validation[invcandsV$valid & invcandsV$hzgood & invcandsV$admixed] <- "d:F3:HZ"
